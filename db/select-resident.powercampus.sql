...
AND (ACADEMIC.POPULATION = 'TRAD' OR ACADEMIC.POPULATION = 'TRANSF' OR ACADEMIC.POPULATION = 'INTRAD' OR ACADEMIC.POPULATION = 'INTRAN' OR AND ACADEMIC.POPULATION = 'SPCL')
--AND (RESIDENCY.RESIDENT_COMMUTER = 'R' OR RESIDENCY.RESIDENT_COMMUTER = 'C')